...
MAX_POKEMON_ID = 898  ## this is the latest pokemon as of 2021
...
One of the possible outcomes of this program is:
```
Choose a mode:
1. Single player
2. Two players
Enter the number of the mode you want to play: 1
Welcome to the Pokemon Battle!
Player 1, your pokemon is:
Hitmonlee (Fighting) - Attack: 120, Defense: 53
Press enter to continue...
The CPU has chosen its pokemon:
Popplio (Water) - Attack: 54, Defense: 54
